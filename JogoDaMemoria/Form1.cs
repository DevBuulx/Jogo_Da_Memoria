...
namespace JogoDaMemoria
{
    public partial class Form1 : Form
    {
        ...
        private void ImagensClick_Click(object sender, EventArgs e)
        {
            ...
            {
                movimentos++;
                lblMovimentos.Text = "Jogadas:" + movimentos.ToString();
        ...
        private void FinalJogo()
        {
            ...
            {
                MessageBox.Show("DevBuulx: Parabéns, você terminou o jogo com " + movimentos.ToString() + " Jogadas");
                DialogResult msg = MessageBox.Show("DevBuulx: Deseja continuar o jogo?", "Jogo da Memória", MessageBoxButtons.YesNo);
                ...
                {
                    MessageBox.Show("DevBuulx: Obrigado por jogar!");
                    Application.Exit();
                }
            }
        }
